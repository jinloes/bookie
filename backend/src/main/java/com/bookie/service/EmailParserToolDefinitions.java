  ...
  public List<LlmToolDefinition> createTools() {
    return List.of(
        LlmToolDefinition.builder()
            ...
            .description(
                "Use this when no financial activity was supplied by the import context and stable"
                    + " email keywords may match confirmed activity history; use a result only when"
                    + " it is unambiguous.")
        ...
        LlmToolDefinition.builder()
            ...
            .description(
                "Use this after a financial activity and direction are known to retrieve category"
                    + " history scoped to that activity; use the exact returned category key.")
        ...
        LlmToolDefinition.builder()
            ...
            .description(
                "Use this when you have account numbers and need a canonical payer name before"
                    + " other payer lookups.")
        ...
        LlmToolDefinition.builder()
            ...
            .description(
                "Use this when account-number and exact-name payer lookups failed; pass possible"
                    + " aliases from the email.")
        ...
        LlmToolDefinition.builder()
            .name("getPayerHints")
            .description(
                "Use this when payer account and alias lookups return empty and you need"
                    + " history-based payer candidates from keywords.")
            .parameters(stringArrayParamSchema("keywords"))
        ...
        LlmToolDefinition.builder()
            ...
            .description(
                "Use this when you have account numbers and need a canonical property name before"
        ...
        LlmToolDefinition.builder()
            ...
            .description(
                "Use this when property account-number lookup is empty; provide payerName and"
                    + " keywords for history-based property candidates.")
        ...
        LlmToolDefinition.builder()
            ...
            .description(
                "Use this when you need category candidates from keyword history before falling"
                    + " back to your own guess.")
            .parameters(stringArrayParamSchema("keywords"))
        ...
        LlmToolDefinition.builder()
            ...
            .description(
                "Use this when keyword category hints are empty; pass the canonical payer name to"
                    + " get strong payer-category history.")
