...
class PropertyServiceTest {
    ...
    @BeforeEach
    void setUp() {
        property = new Property(1L, "123 Main St", "123 Main St, Springfield, IL", PropertyType.SINGLE_FAMILY, "Corner lot");
    }
    ...
    void update_updatesFieldsAndSaves() {
        Property updated = new Property(null, "456 Oak Ave", "456 Oak Ave, Springfield, IL", PropertyType.CONDO, "Updated notes");
        when(propertyRepository.findById(1L)).thenReturn(Optional.of(property));
        when(propertyRepository.save(property)).thenReturn(property);
