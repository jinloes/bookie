...
```typescript
import type { ApplicationContextClassLoaderParent } from ''
...
} satisfies ApplicationContextClassLoaderParent
...
const exampleParsed = JSON.parse(exampleJSON) as ApplicationContextClassLoaderParent
