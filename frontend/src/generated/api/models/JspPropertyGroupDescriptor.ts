 ...
 */
export function instanceOfJspPropertyGroupDescriptor(
  value: object
): value is JspPropertyGroupDescriptor {
  return true;
}
...
export function JspPropertyGroupDescriptorFromJSONTyped(
  json: any,
...
export function JspPropertyGroupDescriptorToJSONTyped(
  value?: JspPropertyGroupDescriptor | null,
