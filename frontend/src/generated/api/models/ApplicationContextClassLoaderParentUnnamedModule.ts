 ...
 */
export function instanceOfApplicationContextClassLoaderParentUnnamedModule(
  value: object
): value is ApplicationContextClassLoaderParentUnnamedModule {
  return true;
}

export function ApplicationContextClassLoaderParentUnnamedModuleFromJSON(
  json: any
...
export function ApplicationContextClassLoaderParentUnnamedModuleFromJSONTyped(
  json: any,
  ...
  return {
    ...
    descriptor:
      json['descriptor'] == null
        ? undefined
        : ApplicationContextClassLoaderParentUnnamedModuleDescriptorFromJSON(json['descriptor']),
    named: json['named'] == null ? undefined : json['named'],
    annotations: json['annotations'] == null ? undefined : json['annotations'],
    declaredAnnotations:
      json['declaredAnnotations'] == null ? undefined : json['declaredAnnotations'],
    packages: json['packages'] == null ? undefined : new Set(json['packages']),
    nativeAccessEnabled:
      json['nativeAccessEnabled'] == null ? undefined : json['nativeAccessEnabled'],
    layer: json['layer'] == null ? undefined : json['layer'],
  };
}

export function ApplicationContextClassLoaderParentUnnamedModuleToJSON(
  json: any
): ApplicationContextClassLoaderParentUnnamedModule {
  return ApplicationContextClassLoaderParentUnnamedModuleToJSONTyped(json, false);
}

export function ApplicationContextClassLoaderParentUnnamedModuleToJSONTyped(
  value?: ApplicationContextClassLoaderParentUnnamedModule | null,
  ...
  return {
    ...
    descriptor: ApplicationContextClassLoaderParentUnnamedModuleDescriptorToJSON(
      value['descriptor']
    ),
    named: value['named'],
