...
export function RedirectViewFromJSONTyped(json: any, ignoreDiscriminator: boolean): RedirectView {
  ...
  return {
    applicationContext:
      json['applicationContext'] == null
        ? undefined
        : ApplicationContextFromJSON(json['applicationContext']),
    servletContext:
      json['servletContext'] == null ? undefined : ServletContextFromJSON(json['servletContext']),
    contentType: json['contentType'] == null ? undefined : json['contentType'],
    requestContextAttribute:
      json['requestContextAttribute'] == null ? undefined : json['requestContextAttribute'],
    staticAttributes: json['staticAttributes'] == null ? undefined : json['staticAttributes'],
    exposePathVariables:
      json['exposePathVariables'] == null ? undefined : json['exposePathVariables'],
    exposeContextBeansAsAttributes:
      json['exposeContextBeansAsAttributes'] == null
        ? undefined
        : json['exposeContextBeansAsAttributes'],
    exposedContextBeanNames:
      json['exposedContextBeanNames'] == null ? undefined : json['exposedContextBeanNames'],
    ...
    exposeModelAttributes:
      json['exposeModelAttributes'] == null ? undefined : json['exposeModelAttributes'],
    encodingScheme: json['encodingScheme'] == null ? undefined : json['encodingScheme'],
    statusCode:
      json['statusCode'] == null ? undefined : RedirectViewStatusCodeFromJSON(json['statusCode']),
    expandUriTemplateVariables:
      json['expandUriTemplateVariables'] == null ? undefined : json['expandUriTemplateVariables'],
...
export function RedirectViewToJSONTyped(
  value?: RedirectView | null,
