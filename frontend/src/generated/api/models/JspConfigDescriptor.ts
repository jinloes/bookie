 ...
 */
export function instanceOfJspConfigDescriptor(value: object): value is JspConfigDescriptor {
    return true;
}
...
export function JspConfigDescriptorFromJSONTyped(json: any, ignoreDiscriminator: boolean): JspConfigDescriptor {
    if (json == null) {
        return json;
    }
    return {
...
export function JspConfigDescriptorToJSONTyped(value?: JspConfigDescriptor | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
