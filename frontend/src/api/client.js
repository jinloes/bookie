...
export const transactionApi = new apis.TransactionControllerApi(configuration);
export const classificationHistoryApi = new apis.LegacyClassificationHistoryControllerApi(
  configuration
);
